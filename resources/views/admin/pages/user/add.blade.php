...
@section('content')
<h1>User <small class="text-muted">Tambah</h1>
<hr>
				...
				<div class="card-header">
					...
					<div class="card-body">
						...
						<div class="form-group form-label-group">
							...
							@if($errors->has('name'))
							<div class="invalid-feedback">{{ $errrors->first('name') }}</div>
							@endif
						</div><!--End Form Group-->
						...
						<div class="form-group form-label-group">
							...
							@if($errors->has('email'))
							<div class="invalid-feedback">{{ $errrors->first('email') }}</div>
							@endif
						</div><!--End Form Group-->
						...
						<div class="form-group form-label-group">
							...
							<div class="invalid-feedback">{{ $errrors->first('password') }}</div>
							@endif
						</div><!--End Form Group-->
						...
						<div class="form-group form-label-group">
							...
							<div class="invalid-feedback">{{ $errrors->first('repassword') }}</div>
							@endif
						</div><!--End Form Group-->
